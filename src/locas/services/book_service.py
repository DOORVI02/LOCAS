...
from locas.core.exceptions import NotFoundError, ValidationError, AuthorizationError, DuplicateError
...
from locas.utils.validators import validate_isbn, validate_barcode
    ...
    def delete_book(self, book_id: int) -> bool:
        ...
        if issued_count > 0:
            raise ValidationError(
                f"Cannot delete book with {issued_count} issued copies. "
