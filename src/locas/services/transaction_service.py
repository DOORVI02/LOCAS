...
from locas.utils.date_utils import calculate_days_overdue, calculate_due_date
...
class TransactionService:
    ...
    def issue_book(
        ...
        self.audit_repo.log_action(
            ...
            new_value={"copy_id": copy_id, "student_id": student_id, "due_date": str(due_date)},
        )
    ...
    def issue_book_by_barcode(
        ...
        return self.issue_book(
            copy_id=copy.copy_id, student_id=student.user_id, due_date=due_date, remarks=remarks
        )
    ...
    def return_book(
        self, transaction_id: int, remarks: str | None = None
    ...
    def return_book_by_barcode(
        self, barcode: str, remarks: str | None = None
    ) -> tuple[Transaction, Decimal | None]:
    ...
    def get_active_transactions(self, limit: int = 100) -> list[Transaction]:
        ...
        """
        return self.trans_repo.find_all_with_details(limit=limit, status=TransactionStatus.ACTIVE)
    ...
    def get_user_transactions(
        self, user_id: int, status: TransactionStatus | None = None, limit: int = 100
    ) -> list[Transaction]:
