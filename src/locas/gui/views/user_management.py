...
class UserManagementView(QWidget):
    ...
    def _add_user(self) -> None:
        ...
        dialog = FormDialog(
            ...
            fields=[
                ...
                FormField("role_id", "Role", field_type="select", required=True,
    ...
    def _edit_user(self) -> None:
        ...
        dialog = FormDialog(
            ...
            fields=[
                ...
                FormField("full_name", "Full Name", required=True, default=self._selected_user.full_name),
                FormField("role_id", "Role", field_type="select", required=True,
                          options=[("Admin", 1), ("Librarian", 2), ("Student", 3)],
    ...
    def _delete_user(self) -> None:
        ...
        try:
            ...
            QMessageBox.information(
                self, "Success",
                f"User '{self._selected_user.username}' deleted successfully!"
            )
