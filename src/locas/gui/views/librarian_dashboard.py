...
class LibrarianDashboard(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.issue_return = IssueReturnView(self.config, self.db_manager, self.session_manager)
        ...
        self.reports = ReportsView(self.config, self.db_manager, self.session_manager)
