...
class IssueReturnView(QWidget):
    ...
    def __init__(
        ...
        self._selected_copy: BookCopy | None = None
        self._selected_student: User | None = None
        self._selected_transaction: Transaction | None = None
        ...
        try:
            ...
            for copy in available_copies:
                self.issue_copy_combo.addItem(
                    f"{copy.barcode} ({copy.location or 'No location'})", copy.copy_id
                )
    ...
    def _issue_book(self) -> None:
        ...
        try:
            transaction = self.trans_service.issue_book(
                copy_id=copy_id, student_id=self._selected_student.user_id, remarks=remarks
            )
                ...
                if books:
                    ...
                    for t in all_transactions:
                        ...
                        if hasattr(t, "book_id") and t.book_id in book_ids:
                            matching.append(t)
                        elif t.book_title and any(
                            query.lower() in t.book_title.lower() for b in books
                        ):
                            matching.append(t)
    ...
    def _create_active_loans_tab(self) -> QWidget:
        ...
        self.loans_filter.addItems(
            ["All Active Loans", "Overdue Only", "Due Today", "Due This Week"]
        )
        ...
        self.all_loans_table = DataTable(
            [
                ...
                {"key": "issue_date", "label": "Issued", "width": 90},
                {
                    ...
                    "label": "Status",
                    "width": 130,
                    "formatter": format_overdue_status,
                },
            ]
        )
