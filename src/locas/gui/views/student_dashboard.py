...
from locas.utils.formatters import format_currency, format_date
...
class DashboardCard(QFrame):
    ...
    def __init__(
        self, title: str, value: str, color: str = "#1976D2", parent: QWidget | None = None
    ) -> None:
...
class StudentDashboard(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.limit_card = DashboardCard(
            "Borrow Limit", str(self.config.max_borrow_limit), "#388E3C"
        )
        ...
        self.books_table.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        ...
        self.fines_table.setHorizontalHeaderLabels(["Book", "Amount", "Reason", "Status"])
        self.fines_table.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        ...
        # Search Books tab
        self.book_search_view = BookSearchView(self.config, self.db_manager, self.session_manager)
