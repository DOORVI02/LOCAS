...
class DatabaseManager:
    ...
    @contextmanager
    def cursor(
        self, dictionary: bool = True, buffered: bool = True
    ...
    def execute(
        self, query: str, params: tuple | None = None, commit: bool = False
    ) -> list[dict[str, Any]]:
    ...
    def execute_insert(self, query: str, params: tuple | None = None) -> int:
