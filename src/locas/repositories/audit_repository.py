...
class AuditRepository(BaseRepository[AuditLog]):
    ...
    def find_by_entity(self, entity_type: str, entity_id: int, limit: int = 50) -> list[AuditLog]:
    ...
    def find_by_user(self, user_id: int, limit: int = 100, offset: int = 0) -> list[AuditLog]:
        ...
        Returns:
            List of AuditLog instances.
        """
        return self.find_all_with_users(limit=limit, offset=offset, user_id=user_id)
