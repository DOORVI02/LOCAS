...
def format_date(dt: date | datetime | None, format_str: str | None = None) -> str:
...
def format_datetime(dt: datetime | None, format_str: str | None = None) -> str:
...
def format_currency(
    amount: Decimal | float | int, symbol: str = "₹", decimal_places: int = 2
) -> str:
