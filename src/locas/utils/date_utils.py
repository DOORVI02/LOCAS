...
def calculate_due_date(issue_date: date | datetime | None = None, borrow_days: int = 14) -> date:
...
def calculate_days_overdue(
    due_date: date | datetime, return_date: date | datetime | None = None
) -> int:
...
def is_overdue(due_date: date | datetime, check_date: date | datetime | None = None) -> bool:
...
def days_until_due(due_date: date | datetime) -> int:
...
def format_relative_date(dt: date | datetime) -> str:
